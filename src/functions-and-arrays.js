...
function doesWordExist(wordsFind) {
  ...
  for (let i = 0; i < wordsFind.length; i++) {
    let palabraAleatoria = wordsFind[0];

    if (wordsFind[i] === palabraAleatoria) {
      continue;
    } else {
      return false;
    }
